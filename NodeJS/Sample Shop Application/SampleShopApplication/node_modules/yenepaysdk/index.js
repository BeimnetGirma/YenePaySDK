...
//   self.pdtUrlSandbox = "https://testapi.yenepay.com/api/verify/pdt/";
  self.checkoutBaseUrlProd = "http://localhost/checkout/Home/Process/";
  self.checkoutBaseUrlSandbox = "http://localhost:8084/checkout/Home/Process/";
  self.ipnVerifyUrlProd = "http://localhost/ETPay.Api/api/verify/ipn/";
  self.ipnVerifyUrlSandbox = "http://localhost:8084/ETPay.Api/api/verify/ipn/";
  self.pdtUrlProd = "http://localhost/ETPay.Api/api/verify/pdt/";
  self.pdtUrlSandbox = "http://localhost:8084/ETPay.Api/api/verify/pdt/";
