...
module.exports = function(sellerCode, merchantOrderId = "", process = _checkoutType.Express, useSandbox = false, expiresInDays = null, successReturn = "", cancelReturn = "", ipnUrl = "", failureUrl = "")
    {
        var self = this;
        ...
        self.GetAsKeyValue = function(forCart){
            var dic = {
                ...
                ExpiresInDays: self.ExpiresInDays,
